...
export const metadata: Metadata = {
  ...
  description: "Directions and event location details for the Columbus Turkey Trot in Columbus, Ohio.",
};

const tips = [
  {
    title: "Primary Parking",
    body: "Use available public parking around Shops on Lane Avenue and nearby streets.",
    icon: <ParkingCircle className="h-5 w-5" strokeWidth={2.2} />,
  },
  {
    title: "Arrive Early",
    body: "Give yourself time to park, warm up, and find your start area before Thanksgiving morning start times.",
    icon: <Clock3 className="h-5 w-5" strokeWidth={2.2} />,
  },
  {
    title: "Be Road-Ready",
    body: "Follow event signage and volunteers on site for safe arrival and race flow.",
  ...
  return (
    <PageShell
      ...
      hero={{
        ...
        subtitle:
          "Use the map below for directions to Shops on Lane Avenue, plus quick notes for arrival.",
          ...
          <div className="lg:col-span-7">
            <div className="overflow-hidden rounded-[24px] border border-white/15 bg-white/5 shadow-[0_18px_44px_rgba(0,0,0,0.30)]">
              ...
              <div className="h-[340px] w-full sm:h-[420px] lg:h-[520px]">
                <iframe
                  title="Shops on Lane Avenue map"
                  src="https://www.google.com/maps?q=1675%20W%20Lane%20Ave%2C%20Columbus%2C%20OH%2043221&z=15&output=embed"
