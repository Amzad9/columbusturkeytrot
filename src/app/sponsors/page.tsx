...
export const metadata: Metadata = {
  ...
  description:
    "Meet the sponsors supporting Columbus Turkey Trot and learn how to sponsor the event.",
};
...
const sponsorTiers: SponsorTier[] = [
  ...
  },
  {
    ...
    sponsors: [
      {
        name: "Domino’s",
        logoSrc: "https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=500&q=80",
      },
    ],
  },
  {
    ...
    sponsors: [
      {
        name: "Skyline",
        logoSrc: "https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&w=500&q=80",
      },
    ],
  },
  {
    tier: "Friend of Turkey Trot",
    accent: "#9ee6c1",
        ...
        <div className="rounded-2xl border border-white/15 bg-white/5 p-5">
          ...
          {blurb ? (
            ...
            <p className="mt-3 max-w-xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8">
              Thank you for supporting Columbus Turkey Trot.
            </p>
          )}
        </div>
